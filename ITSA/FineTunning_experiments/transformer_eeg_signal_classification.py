...
### BLOCK DESIGN ###
# Data
parser.add_argument('-ed', '--eeg-dataset', default=r"/kaggle/input/datasets/marii04/eeg-datasets/eeg_55_95_std.pth",
                    help="EEG dataset path")  # 55-95Hz
...
parser.add_argument('-sp', '--splits-path',
                    default=r"/kaggle/input/datasets/marii04/splits-all-subjects/block_splits_by_image_all.pth",
...
parser.add_argument('--adapt_new_subject', default=False, action="store_true",
                    help="Adapt pretrained ITSA to a new subject")
